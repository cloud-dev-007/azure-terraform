...
variable "postgres_admin_password" {
  description = "PostgreSQL admin password - must be provided via TF_VAR_postgres_admin_password environment variable or .tfvars file"
  type        = string
  sensitive   = true
}
...
# Optional infrastructure applications (like ingress controllers, monitoring)
variable "infrastructure_applications" {
  description = "Infrastructure-level applications to deploy"
  type = map(object({
    repository       = string
    chart            = string
    version          = string
  ...
  # default = {
  #   # Example: NGINX Ingress Controller (optional)
  #   "ingress-nginx" = {
